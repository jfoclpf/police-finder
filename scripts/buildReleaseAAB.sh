...
cd ../../../../../../..
rm -f dist/policeFinder.aab

cp platforms/android/app/build/outputs/bundle/release/app-release.aab dist/policeFinder.aab

GREEN=$(tput setaf 2)
printf "\n\n${GREEN}File created at: dist/policeFinder.aab\n\n"
