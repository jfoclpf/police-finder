...
zipalign -v 4 app-release-unsigned.apk policeFinder.apk

cd ../../../../../../..
rm -f dist/policeFinder.apk

cp platforms/android/app/build/outputs/apk/release/policeFinder.apk dist/

GREEN=$(tput setaf 2)
printf "\n\n${GREEN}File created at: dist/policeFinder.apk\n\n"
